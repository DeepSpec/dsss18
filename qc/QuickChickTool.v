...
(**  By the way, why did we call the tool [quickChick] instead of
  [quickchick] -- the latter seems easier to both read and type... 
 *)
(**  No idea :) 
 *)
...
(**  Should the reader type something in a command line at this
   point? 
 *)
(**  No, just execute the following command inline. 
 *)
(** 
...
(**  What do we type to get this? 
 *)
(**  Just uncommment the previous command... 
 *)
(** 
...
(**  Suggestion: Instead of turning the wrong version into a mutant ourselves, let's make an exercise suggesting how the reader should do it.  In general, it would be good to have a few exercises. 
 *)
(**  I agree about the exercise, I just wasn't sure which parts to turn into an exercise 
   and wanted to push through with the main narrative. 
 *)
