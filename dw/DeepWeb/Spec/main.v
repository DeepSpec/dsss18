...
Definition _argc : ident := 155%positive.
Definition _argv : ident := 156%positive.
...
Definition _main : ident := 157%positive.
...
Definition _t'1 : ident := 158%positive.
Definition _t'2 : ident := 159%positive.
Definition _t'3 : ident := 160%positive.
Definition _t'4 : ident := 161%positive.
