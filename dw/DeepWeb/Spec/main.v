...
Definition v___stringlit_1 := {|
  gvar_info := (tarray tschar 5);
  gvar_init := (Init_int8 (Int.repr 56) :: Init_int8 (Int.repr 48) ::
            ...
            (Ssequence
              ...
              (Scall (Some _t'2)
                (Evar _htons (Tfunction (Tcons tushort Tnil) tushort
                               cc_default)) ((Etempvar _t'1 tint) :: nil)))
            (Sassign
              (Efield (Evar _addr (Tstruct _sockaddr_in noattr)) _sin_port
                tushort) (Etempvar _t'2 tushort)))
          (Ssequence
            (Ssequence
              (Scall (Some _t'3)
            ...
            (Ssequence
              ...
              (Ssequence
                ...
                (Ssequence
                  (Ssequence
                    (Scall (Some _t'5)
                      (Evar _listen (Tfunction (Tcons tint (Tcons tint Tnil))
                                      tint cc_default))
                      ((Etempvar _fd tint) ::
                       (Econst_int (Int.repr 128) tint) :: nil))
                    (Sset _r (Etempvar _t'5 tint)))
                  (Ssequence
                    (Sifthenelse (Ebinop Olt (Etempvar _r tint)
                                   (Econst_int (Int.repr 0) tint) tint)
                    ...
                    (Ssequence
                      (Ssequence
                        (Scall (Some _t'6)
                          (Evar _new_store (Tfunction Tnil
                                             (tptr (Tstruct _store noattr))
                                             cc_default)) nil)
                        (Sset _last_msg_store
                          (Etempvar _t'6 (tptr (Tstruct _store noattr)))))
                      (Ssequence
                        (Sifthenelse (Ebinop Oeq
                                       (Etempvar _last_msg_store (tptr (Tstruct _store noattr)))
